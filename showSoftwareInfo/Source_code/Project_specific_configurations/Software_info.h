		...
		*/
		...
		/* 如果是 C++ 編譯器則停用 C++ 特有的函式名稱 mangling*/
			 ...
			 * Definition of constants & macros */
				...
				/*用在著作權宣告的軟體釋出年份*/
					#define SOFTWARE_RELEASE_YEAR "2012, 2013"
				/* 用在軟體所使用的授權條款版本（目前尚未實作）
				 * 有效值："「數字」（+）" "NONE"
					#define SOFTWARE_LICENSE_VERSION "3+"*/
				/* 軟體的官方網站 */
					#define SOFTWARE_OFFICIAL_SITE "https://github.com/Vdragon/Vdragons_C_CPP_Libraries_Collection"
				/* 軟體的問題回報地址 */
					#define SOFTWARE_ISSUE_REPORT_ADDRESS "https://github.com/Vdragon/Vdragons_C_CPP_Libraries_Collection/issues"
