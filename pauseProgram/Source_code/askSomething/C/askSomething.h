/* include guard：避免同一個 header 檔案被 include 第二次 */
		...
		/*程式名稱
			Program name */
			#define PROGRAM_NAME "org.vsdg.lib.vccl.askSomething"
			#define PROGRAM_NAME_READABLE "askSomething library"
		/*更新紀錄
			Changelog
		...
		*/
		...
		/* 如果是 C++ 編譯器則停用 C++ 特有的函式名稱 mangling*/
			 ...
			 *  Definition of data type, enumeration, data structure and class */
				typedef enum askSomething_answer{
					ASKSOMETHING_SUCCESS = 0, ASKSOMETHING_FAIL
				}AskSomething_answer;

			/* 函式雛型
				 Function prototypes */
				/* ask an signed integer */
