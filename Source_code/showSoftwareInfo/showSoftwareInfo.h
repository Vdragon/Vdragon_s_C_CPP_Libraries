...
*/
  /* 如果是C++編譯器則停用C++特有的函式名稱mangling*/
	...
	enum software_license{
		SOFTWARE_LICENSE_UNDEFINED, SOFTWARE_LICENSE_OTHER, SOFTWARE_LICENSE_GPL, SOFTWARE_LICENSE_LGPL, SOFTWARE_LICENSE_PUBLIC_DOMAIN, SOFTWARE_LICENSE_CC0, SOFTWARE_LICENSE_WTFPL, SOFTWARE_LICENSE_MIT, SOFTWARE_LICENSE_BSD_3_CLAUSE, SOFTWARE_LICENSE_BSD_2_CLAUSE, SOFTWARE_LICENSE_MPL, SOFTWARE_LICENSE_APACHE
	};
