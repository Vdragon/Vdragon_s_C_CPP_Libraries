/* include guard：避免同一個 header 檔案被 include 第二次 */
	#ifndef Swap_algorithm_C_unit_test.c
		/*程式名稱
			Program name */
			#define Swap_algorithm_C_unit_test.c "org.vsdg.lib.VCCL.Swap_algorithm_C.unit_test"
			#define Swap_algorithm_C_unit_test.c_READABLE "Swap_algorithm_C unit test"
		/*更新紀錄
			Changelog
		...
		*/
		...
		/* 如果是 C++ 編譯器則停用 C++ 特有的函式名稱 mangling*/
			...
			#endif /* __cplusplus */
	#endif/* Swap_algorithm_C_unit_test.c */
